...
export const EVENTS: CyclingEvent[] = [
  ...
  },
  {
    ...
    discipline: "route",
    region: "Haute-Savoie",
    city: "À confirmer selon parcours",
    date: "2026-07-19",
    dateLabel: "Édition 2026, mi-juillet",
    cover: "https://images.unsplash.com/photo-1559348349-86f1f65817fe?w=900&q=85",
    description: "Cyclosportive amateur sur le parcours d'une vraie étape du Tour de France, organisée par ASO depuis 1993. Routes fermées, 16 000 cyclos au départ. La ville et le parcours 2026 seront confirmés avec l'annonce du Tour.",
    organizer: "Amaury Sport Organisation",
    websiteUrl: "https://www.letapedutour.com",
    pricesFromEuros: 130,
    difficulty: "expert",
  },
  {
    id: "tour-france-2026",
    title: "Tour de France (étapes alpines)",
    kind: "course",
    discipline: "route",
    region: "Savoie",
    city: "Itinérant",
    ...
    dateLabel: "Édition 2026, juillet",
    cover: "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=900&q=85",
    description: "Le Tour passe chaque année par les Alpes. Les étapes alpines 2026 seront confirmées avec la présentation du parcours en octobre 2025. Spectacle public gratuit, caravane sponsors, ambiance populaire.",
    organizer: "Amaury Sport Organisation",
    websiteUrl: "https://www.letour.fr",
    isFamily: true,
  },
  {
    id: "ardechoise-2026",
    ...
    discipline: "route",
    region: "Drôme",
    city: "Saint-Félicien (Ardèche frontalière)",
    date: "2026-06-17",
    endDate: "2026-06-20",
    dateLabel: "Édition 2026, mi-juin",
    cover: "https://images.unsplash.com/photo-1517649763962-0c623066013b?w=900&q=85",
    description: "Plus grande cyclosportive de France organisée depuis 1992 : 4 jours, jusqu'à 16 000 participants, multiples parcours du familial au 600 km. Région frontalière de la Drôme et du Vercors.",
    organizer: "L'Ardéchoise",
    websiteUrl: "https://www.ardechoise.com",
    pricesFromEuros: 35,
    distancesKm: [70, 120, 175, 220],
    elevationGainsM: [1400, 2400, 3500, 4500],
    isFamily: true,
    difficulty: "mixte",
  },
  {
    ...
    city: "Arbent",
    date: "2026-09-13",
    dateLabel: "Édition 2026, septembre",
    cover: "https://images.unsplash.com/photo-1591619759638-36921634f97e?w=900&q=85",
    description: "Plus ancienne cyclosportive VTT de France, organisée depuis 1985 dans le Haut-Bugey. Parcours du randonneur au compétiteur, ravitaillements de qualité, ambiance conviviale.",
    organizer: "La Forestière",
    websiteUrl: "https://www.la-forestiere.com",
    pricesFromEuros: 30,
    distancesKm: [25, 45, 75, 95],
    elevationGainsM: [600, 1300, 2100, 2700],
    isFamily: true,
    difficulty: "mixte",
  },
];
